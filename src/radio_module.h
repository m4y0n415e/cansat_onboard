 ...
 * @details This function calls the underlying driver initialization routine. It sets up 
 ...
 * @details This function takes individual sensor readings, formats them into a standard 
